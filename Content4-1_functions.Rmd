---
title: "Content 4-1: Introduction to functions"
...
We'll learn more about types function arguments next week, but from this help file you can see that the inputs to the `mean()` function are a vector, `x`, of which we will calculate the mean and some options for calculating the mean called `trim`, `na.rm`, and `...`.  
