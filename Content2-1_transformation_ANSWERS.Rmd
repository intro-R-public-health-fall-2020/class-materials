...
5. 5. Sort individuals in this dataset to find the youngest people. Remember you can force `R` to show all the columns with the `print()` function and `width = Inf`.
