...
**Income has a meaningful ordering by amount of income.  Party ID could also be considered a meaningful ordering, since the levels move along a spectrum from Republican to Democrat.  None of the other factor variable have a meaningful order.**
```{r}
gss_cat
...
**Because the first factor level is plotted where the 1 would be on he x-axis, the second level is plotted where the 2 would be, etc.  So the first level is at the bottom of the plot.**
```{r}
